...
# Ri - Li > 0. You may assume all buildings are perfect rectangles grounded
...
# used to mark the termination of the skyline, and always has zero height.
...
# in the output skyline. For instance,
